...
Character.create([
                   ...
                   { name: 'Trinity', description: 'a truly inspirational leader and influential teacher to many people' },
                   { name: 'Morpheus', description: 'a computer programmer and a hacker who has escaped from the Matrix' },
